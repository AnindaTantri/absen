...
function CreateData()
{
    ...
    $jumlah = mysqli_real_escape_string($GLOBALS['link'], trim($_POST['jumlah_peserta']));
    $mulai = mysqli_real_escape_string($GLOBALS['link'], trim($_POST['mulai']));
    $selesai = mysqli_real_escape_string($GLOBALS['link'], trim($_POST['selesai']));
    $durasi = mysqli_real_escape_string($GLOBALS['link'], trim($_POST['durasi']));
